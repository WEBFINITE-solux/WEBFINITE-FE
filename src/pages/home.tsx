...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const response = await fetch(
          `https://d291-58-29-179-25.ngrok-free.app/profile/${userId}`,
          {
            method: "GET",
            headers: {
    ...
    const fetchStudyPlan = async () => {
      try {
        ...
        const courseId = courseData.courses[0]
          ? courseData.courses[0].id
          : null;
        if (courseId) {
          const response = await fetch(
  ...
  const handleChangeProfileImage = async (newImg: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://d291-58-29-179-25.ngrok-free.app/profile/${profileId}/image`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
      ...
      <div className="left">
        ...
        <div style={{ display: "flex", gap: "20px" }}>
          <div>
            ...
            <div className="table" style={{ height: "200px", width: "680px" }}>
              {<TodoListHome />}
            </div>
          </div>
          <div>
      ...
      <div className="right">
        ...
        >
          ...
          <div style={{ textAlign: "center" }}>
              ...
              <div>
                ...
                >
                  ...
                  >
                    <button
                      onClick={() => {
                        handleChangeProfileImage("img1"), setShowImg(false);
                      }}
                      style={{
                        padding: "0px",
                    ...
                    <button
                      onClick={() => {
                        handleChangeProfileImage("img2"), setShowImg(false);
                      }}
                      style={{
                        padding: "0px",
                        backgroundColor: "rgba(0,0,0,0)",
                    ...
                    <button
                      onClick={() => {
                        handleChangeProfileImage("img3"), setShowImg(false);
                      }}
                      style={{
                        padding: "0px",
                        backgroundColor: "rgba(0,0,0,0)",
                    ...
                    <button
                      onClick={() => {
                        handleChangeProfileImage("img4"), setShowImg(false);
                      }}
                      style={{
                        padding: "0px",
                        backgroundColor: "rgba(0,0,0,0)",
                    ...
                    <button
                      onClick={() => {
                        handleChangeProfileImage("img5"), setShowImg(false);
                      }}
                      style={{
                        padding: "0px",
                        backgroundColor: "rgba(0,0,0,0)",
            ...
            <p style={{ fontWeight: "normal", color: "#747474" }}>
              {introduction}
            </p>
          </div>
          <div>
